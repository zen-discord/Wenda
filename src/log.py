...
class Logger:
    def __init__(
        self, process_name: str, log_format: Template, time_format: str
    ) -> None:
    ...
    def info(self, message) -> None:
        log = self.format.substitute(
            time=self.get_time(),
            process=self.name,
            level=COLORED_LEVELS["info"],
